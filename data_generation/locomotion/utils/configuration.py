...
smplx_folder = './models/smplx_model/'
scannet_folder = './ScanNet/scannet/scans'

pure_motion_folder = './HUMANISE/files/pure_motion/'
align_data_folder = './HUMANISE/files/align_data_release/'

preprocess_scene_folder = './Pointnet2.ScanNet/preprocessing/scannet_scenes'
