...
if __name__ == "__main__":
    ...
    amass_root = './thirdparty/HumanML3D/amass_data/'
    # file_lists = ['./dataset/HumanML3D/train_sit_clean.txt',
    #               './dataset/HumanML3D/test_sit_clean.txt']
    file_lists = ['/home/hyi/data/dataset/humanise_bundle/scene_aware_motion_gen/dataset/HumanML3D/train_all_sit_new_no_ground.txt']
    annotation_file = './dataset/HumanML3D/annotations.json'
    output_dir = './dataset/HumanML3D/summon/ds_verts'    
    ...
    smplx_models = "./smpl-x_model/models"
    ...
    seq_list = list(set([seq.replace('M', '') for seq in seq_list]))
    ...
    for seq in tqdm(seq_list):
        ...
        if os.path.exists(input_path):
            ...
            output_seq_list.append(seq)
        else:
            failed_cnt += 1
    print(failed_cnt, len(seq_list) - failed_cnt)
    with open(os.path.join(output_dir, 'seq_list_0128.txt'), 'w') as f:
