...
class SMPL(_SMPLLayer):
    ...
    def forward(self, *args, **kwargs):
        ...
        # smpl_output = super(SMPL, self).forward(*args, **kwargs) # this is useful !!!!
        # import pdb;pdb.set_trace()
        tmp = {'body_pose':kwargs['body_pose'], 'global_orient': kwargs['global_orient'], 'betas': kwargs['betas']}
        smpl_output = super(SMPL, self).forward(*args, **tmp)
